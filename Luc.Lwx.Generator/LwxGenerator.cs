...
[Generator]
internal class LwxGenerator : IIncrementalGenerator
{
    public const string LwxEndpointCategory = "Luc.Lwx";    
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        (
            ...
            (sourceProductionContext, typeSymbols) => 
            {
                ...
                var processor = new LwxGenerator_Assembly(sourceProductionContext, allAppSettings, allTypes);
                processor.Execute();
            }
        );
    }  
