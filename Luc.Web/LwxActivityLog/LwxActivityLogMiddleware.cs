...
) : IMiddleware
{
    ...
    /// </summary>
    private static async Task HandleLucWebResponseException(LwxResponseError e, LwxRecord record, HttpContext context)
    {
        var response = new LwxResponseBase
        {
            Ok = false,
    ...
    /// </summary>
    private static async Task HandleGeneralException(Exception e, LwxRecord record, HttpContext context)
    {
        var response = new LwxResponseBase
        {
            Ok = false,
